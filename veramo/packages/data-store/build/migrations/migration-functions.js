 ...
 * @public
 */
export function migrationGetExistingTableByName(queryRunner, givenName, strictClassName) {
 ...
 * @public
 */
export function migrationGetTableName(queryRunner, givenName, strictClassName) {
    const table = migrationGetTableByNameImpl(queryRunner, givenName, strictClassName);
