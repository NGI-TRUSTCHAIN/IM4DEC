...
export const getPresentationsTable = async (agent, screen) => {
    ...
    presentationsTable.setData([['Created', 'Type', 'Holder', 'Verifier']].concat(presentations.map(({ verifiablePresentation: m }) => [
