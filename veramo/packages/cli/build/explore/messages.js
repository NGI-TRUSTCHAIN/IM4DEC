...
export const getMessagesTable = async (agent, screen) => {
    ...
    messageTable.setData([['Created', 'Type', 'From', 'To']].concat(messages.map((m) => [shortDate(m.createdAt), m.type, shortDid(m.from), shortDid(m.to)])));
